...
#+END_LaTeX
** Kameleon Features
- Structured language based on few constructs and 
  which relies on shell commands make it easy to use
- The hierarchical structure of recipes and the extend 
  mechanism allow shareability. 
