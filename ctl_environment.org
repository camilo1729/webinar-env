...
- Docker works with images that consume minimal disk space, are
  versioned, archiveable, and shareable
...
- \bgroup\bf Specific version of packages cannot be installed\egroup
