...
Making it available" is a great first step. Making sure others can rerun
it is an other move
...
- Raw data and code: relies on the published paper for documentation
- Extensive documentation: it could require certain skills
- Adopt a controlled environment -> scientific workflow
...
There is two approaches:
   - preserving the mess by capturing environment already setup
...
\begin{block}{Definition}
   *In our case*:
   An environment is a set of tools and materials that permits a complete
...
Provide isolation with the host

- A virtual environment can only use a limited part of the resources:
      - filesystem
      - memory/cpu/disk/network

- Got his own software stack  => clean dependencies

*What is a container*:\\
   An isolated part of the system that share the operating system kernel

*What is a virtual machine*:\\
   A full system image that share the system hardware though an hypervisor
...
*** Drawbacks
  Nothing is tracking the changes in this environment
...
*Choose your tools*:\\
Reproducibility brings some complexity but more and more tools to manage this
  complexity for you

*Provide environments*:\\
Whatever the environment quality you provide, it is better than no
  environment at all :)

*Better if you provide the recipe*
Provide experiment environment is good, provide the recipe to build this
